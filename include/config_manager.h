...
#define EVENT_ID_EVENT_FORWARD_COLLISION "FORWARD_COLLISION"
#define EVENT_ID_EVENT_LANE_DEPARTURE_WARNING_LEFT_LV1 "LANE_DEPARTURE_WARNING_LEFT_LV1"
#define EVENT_ID_EVENT_LANE_DEPARTURE_WARNING_LEFT_LV2 "LANE_DEPARTURE_WARNING_LEFT_LV2"
#define EVENT_ID_EVENT_LANE_DEPARTURE_WARNING_RIGHT_LV1 "LANE_DEPARTURE_WARNING_RIGHT_LV1"
#define EVENT_ID_EVENT_LANE_DEPARTURE_WARNING_RIGHT_LV2 "LANE_DEPARTURE_WARNING_RIGHT_LV2"
...
typedef enum {
  ...
  CAN_EVENT_LANE_DEPARTURE_WARNING_LEFT_LV1,
  CAN_EVENT_LANE_DEPARTURE_WARNING_LEFT_LV2,
  CAN_EVENT_LANE_DEPARTURE_WARNING_RIGHT_LV1,
  CAN_EVENT_LANE_DEPARTURE_WARNING_RIGHT_LV2,
