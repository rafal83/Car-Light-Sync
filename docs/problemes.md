...
- Si vous êtes sur ESP32-S3 (1 seul TWAI), certaines fonctions nécessitant 2 bus ne seront pas disponibles ; passer sur ESP32-C6 pour l'ensemble des fonctionnalités.
