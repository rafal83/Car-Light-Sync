const translations = {
  fr: {
    ...
    diagnostic: {
      ...
      pandaDescription: "Protocole comma.ai PANDA (À venir prochainement)",
      pandaComingSoon: "Bientôt disponible",
      logsTitle: "Logs en temps réel",
      logsDescription: "Affichage des logs système via Server-Sent Events (WiFi uniquement)",
      logsStatus: "État :",
      logsStart: "Activer les logs",
      logsStop: "Arrêter les logs",
      logsClear: "Effacer",
      logsEmpty: "Aucun log pour le moment...",
      logsConnecting: "Connexion...",
      logsConnected: "Connecté",
      logsDisconnected: "Déconnecté",
      logsError: "Erreur de connexion",
    },
    ota: {
      ...
      gvretTcpTitle: "🔧 Serveur GVRET TCP",
      gvretTcpDescription:
        "Activer le serveur TCP GVRET sur le port 23 pour diagnostique CAN avec SavvyCAN via WiFi (pas de redémarrage requis).",
      gvretStatus: "État :",
      gvretClients: "Clients connectés :",
      gvretStart: "Activer GVRET TCP",
      gvretStop: "Arrêter GVRET TCP",
      gvretRunning: "Actif (Port 23)",
      gvretStopped: "Arrêté",
      gvretStarting: "Démarrage du serveur GVRET TCP...",
      gvretStopping: "Arrêt du serveur GVRET TCP...",
      gvretStarted: "Serveur GVRET TCP démarré avec succès",
      gvretStopped: "Serveur GVRET TCP arrêté avec succès",
      gvretError: "Erreur lors de la communication avec le serveur GVRET",
    },
  },
  en: {
    ...
    diagnostic: {
      ...
      pandaDescription: "comma.ai PANDA protocol (Coming soon)",
      pandaComingSoon: "Coming soon",
      logsTitle: "Live Logs",
      logsDescription: "System logs display via Server-Sent Events (WiFi only)",
      logsStatus: "Status:",
      logsStart: "Enable logs",
      logsStop: "Stop logs",
      logsClear: "Clear",
    ...
    ota: {
      ...
      gvretTcpTitle: "🔧 GVRET TCP Server",
      gvretTcpDescription:
        "Enable GVRET TCP server on port 23 for CAN diagnostics with SavvyCAN via WiFi (no restart required).",
      gvretStatus: "Status:",
      gvretClients: "Connected clients:",
      gvretStart: "Start GVRET TCP",
      gvretStop: "Stop GVRET TCP",
      gvretRunning: "Running (Port 23)",
      gvretStopped: "Stopped",
      gvretStarting: "Starting GVRET TCP server...",
      gvretStopping: "Stopping GVRET TCP server...",
      gvretStarted: "GVRET TCP server started successfully",
      gvretStopped: "GVRET TCP server stopped successfully",
      gvretError: "Error communicating with GVRET server",
    },
  },
};
