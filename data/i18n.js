const translations = {
  fr: {
    ...
    server: {
      ...
      slcanDescription: "Protocole SLCAN/LAWICEL sur TCP port 3333 pour Wireshark/python-can via WiFi",
      slcanStatus: "État :",
  ...
  en: {
    ...
    server: {
      ...
      slcanDescription: "SLCAN/LAWICEL protocol on TCP port 3333 for Wireshark/python-can via WiFi",
      slcanStatus: "Status:",
