const translations = {
  fr: {
    ...
    server: {
      ...
      gvretDescription: "Protocole GVRET sur TCP port 23 pour SavvyCAN via WiFi (pas de redémarrage requis).",
      gvretStatus: "État :",
      ...
      pandaTitle: "Serveur PANDA",
      pandaDescription: "Protocole comma.ai Panda sur TCP port 1338 pour cabana via WiFi (pas de redémarrage requis).",
      pandaStatus: "État :",
      pandaClients: "Clients connectés :",
      pandaPort: "Port TCP :",
      pandaStart: "Activer PANDA",
      pandaStop: "Arrêter PANDA",
      pandaRunning: "Actif (Port 1338)",
      pandaStopped: "Arrêté",
      pandaStarting: "Démarrage du serveur Panda...",
      pandaStopping: "Arrêt du serveur Panda...",
      pandaStarted: "Serveur Panda démarré avec succès",
      pandaError: "Erreur lors de la communication avec le serveur Panda",
      slcanTitle: "Serveur SLCAN",
      slcanDescription: "Protocole SLCAN/LAWICEL sur TCP port 3333 pour Wireshark/python-can via WiFi (pas de redémarrage requis)",
      slcanStatus: "État :",
      slcanClients: "Clients connectés :",
      slcanPort: "Port TCP :",
      slcanStart: "Activer SLCAN",
      slcanStop: "Arrêter SLCAN",
      slcanRunning: "Actif (Port 3333)",
      slcanStopped: "Arrêté",
      slcanStarting: "Démarrage du serveur SLCAN...",
  ...
  en: {
    ...
    server: {
      ...
      gvretDescription: "GVRET protocol on TCP port 23 for SavvyCAN via WiFi (no restart required).",
      gvretStatus: "Status:",
      ...
      pandaTitle: "PANDA Server",
      pandaDescription: "comma.ai Panda protocol on TCP port 1338 for cabana via WiFi (no restart required).",
      pandaStatus: "Status:",
      pandaClients: "Connected clients:",
      pandaPort: "TCP Port:",
      pandaStart: "Start PANDA",
      pandaStop: "Stop PANDA",
      pandaRunning: "Running (Port 1338)",
      pandaStopped: "Stopped",
      pandaStarting: "Starting Panda server...",
      pandaStopping: "Stopping Panda server...",
      pandaStarted: "Panda server started successfully",
      pandaError: "Error communicating with Panda server",
      slcanTitle: "SLCAN Server",
      slcanDescription: "SLCAN/LAWICEL protocol on TCP port 3333 for Wireshark/python-can via WiFi (no restart required)",
      slcanStatus: "Status:",
      slcanClients: "Connected clients:",
      slcanPort: "TCP Port:",
      slcanStart: "Start SLCAN",
      slcanStop: "Stop SLCAN",
      slcanRunning: "Running (Port 3333)",
      slcanStopped: "Stopped",
      slcanStarting: "Starting SLCAN server...",
