            ...
            if (id == 0x36B) {
                ...
                if (id == 0x102) {  // gauche
                    ...
                    if (id == 0x2E1) {
                        ...
                        // ---------------------------------------------------------------------
                        if (id == 0x3F5) {
                            // Clignotants : on stocke seulement l'état binaire, les events sont gérés plus bas
                            ...
                            //  - DAS_blindSpotRearLeft / Right : 0=NO_WARNING, 1/2=warning, 3=SNA
                            // ---------------------------------------------------------------------
                            if (id == 0x399) {
                                        ...
                                        if (id == 0x261) {
                                            ...
                                            if (id == 0x204) {
                                                if (strcmp(name, "PCS_hvChargeStatus") == 0) {
                                                    // 0 = not charging, 2 = charging (d'après le DBC opendbc)
                                                    int v = (int) (value + 0.5f);
                                                    if (v == 2) {
                                                        state->charging = 1;
                                                    } else if (v == 0) {
                                                ...
                                                if (id == 0x273) {
                                                    ...
                                                    if (id == 0x284) {
                                                        if (strcmp(name, "UIsentryMode284") == 0) {
                                                            ...
                                                            return;
                                                        } else if (strcmp(name, "CP_chargeCablePresent") == 0) {
                                                            int v = (int) (value + 0.5f);
